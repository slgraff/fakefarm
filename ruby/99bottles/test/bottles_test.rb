...
class EndingTest < Minitest::Test
  def setup
    @ending = Ending.new
  end

  def test_ending_exists
    assert ::Ending.new
  end

  # def test_ending_is_numeric_based
  #   assert_equal
  # end
end
...
class BottleTest < Minitest::Test
  ...
  def test_bottle_exists
    assert ::Bottle.new
  end

  def test_bottle_knows_quantity
    bottle = ::Bottle.new(1)
  end

  def test_bottle_has_quantity
    assert_equal "bottle", @bottle.phrase
  end
end
